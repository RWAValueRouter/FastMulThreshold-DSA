...
```
git clone https://github.com/RWAValueRouter/FastMulThreshold-DSA.git
```
## Build
...
[keygen-and-sign-workflow](https://github.com/RWAValueRouter/FastMulThreshold-DSA/wiki/keygen-and-sign-workflow)
