...
import (
	...
	keygen "github.com/RWAValueRouter/FastMulThreshold-DSA/smpc-lib/ecdsa/keygen"
...
func GetReqAddrStatus(key string) (string, string, error) {
	...
	// https://github.com/RWAValueRouter/FastMulThreshold-DSA/commit/21949d0fc79d9b5f29bfb11ae715994bb8c355dc
